...
<head>
    ...
    <title>Admin Login - Cozy Habitat</title>
    ...
    <style>
        :root {
            /* Cozy Habitat Unified Brand Colors */
        ...
        * { 
        ...
        body { 
            ...
            /* Animated Dynamic Background looping through custom Warm Light Browns */
        ...
        /* Styled inputs matching the clean look from your client clip */
        .form-group input { 
            width: 100%; 
        ...
        /* Premium Dark Espresso Button with sleek hover effects */
        .btn-submit { 
            width: 100%; 
            padding: 15px; 
        ...
        /* Mismatched credential helper wrapper */
        .error-container {
...
<body>
    ...
    <div class="login-card">
        <div class="brand-title">Cozy Habitat</div>
        <div class="brand-subtitle">Administrative Console</div>
