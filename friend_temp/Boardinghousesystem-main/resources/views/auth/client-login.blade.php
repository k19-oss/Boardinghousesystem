...
<head>
    ...
    <style>
        ...
        /* Laravel Error Alerts styling container */
        .alert-error-glow {
...
<body>
    ...
    <div class="login-card">
        ...
        @if ($errors->any())
            <div class="alert-error-glow">
                <div style="font-weight: 800; margin-bottom: 4px;"><i class="fa-solid fa-triangle-exclamation"></i> Access Denied:</div>
